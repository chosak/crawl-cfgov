...
<head prefix="og: http://ogp.me/ns# fb: http://ogp.me/ns/fb# ">
    ...
    <title>Hace seis meses aumentó la tasa de interés de mi cuenta. Me he dado cuenta de que la tasa de interés se ha reducido, pero todavía no regresa a mi tarifa original. ¿Pueden hacer eso? | Oficina para la Protección Financiera del Consumidor</title>
    ...
    <meta property="og:title" content="Hace seis meses aumentó la tasa de interés de mi cuenta. Me he dado cuenta de que la tasa de interés se ha reducido, pero todavía no regresa a mi tarifa original. ¿Pueden hacer eso? | Oficina para la Protección Financiera del Consumidor">
   ...
   <div class="a-tagline_text">
    ...
    <nav class="breadcrumbs" aria-label="Guía de navegación">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 10 19" class="cf-icon-svg"><path d="M8.4 17.269a1.026 1.026 0 0 1-.727-.302l-6.801-6.8a1.03 1.03 0 0 1 0-1.456l6.8-6.8a1.03 1.03 0 0 1 1.456 1.455L3.055 9.439l6.073 6.073A1.03 1.03 0 0 1 8.4 17.27z"/></svg>
                <a class="breadcrumbs_link" href="/es/herramientas-del-consumidor/tarjetas-de-credito/">
                    Tarjetas de crédito
                </a>
    </nav>
                </div>
<div class="wrapper content_wrapper">
    ...
    <div class="block
                block__flush-top
                block__sub">
            <time datetime='2016-07-08' class="answer-edited-date">revisado: JUL 08, 2016</time>
        <h1>
                ...
                <div class="block block__sub">
                    ...
                    <ul class="m-list m-list__unstyled m-list__links">
                        ...
                        <li class="m-list_item m-list_item__last">
                            <a href="/es/herramientas-del-consumidor/tarjetas-de-credito/" class="m-list_link">
                                <b>
                                    Sepa más sobre
                                    tarjetas de crédito
                                </b>
...
<div class="o-feedback block">
  ...
  <div class="m-notification">
    ...
    <aside class="content_sidebar o-sidebar-content">
        <a class="a-link a-link__jump" data-pretty-href="cfpb.gov/askcfpb/71" href="/ask-cfpb/six-months-ago-the-interest-rate-on-my-account-was-increased-i-have-noticed-that-the-interest-rate-has-been-reduced-but-is-still-not-going-back-to-my-original-rate-can-they-do-that-en-71/">
